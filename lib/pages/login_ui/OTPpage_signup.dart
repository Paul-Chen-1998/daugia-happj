...
class OtpPageSignup extends StatefulWidget {
  final verificationId;
  final phoneNo;

  OtpPageSignup({this.verificationId, this.phoneNo});

  @override
  _OtpPageSignupState createState() => _OtpPageSignupState();
}

class _OtpPageSignupState extends State<OtpPageSignup> {
  ...
  Widget otpNumberWidget(int position) {
    try {
      return Container(
        ...
        child: Center(child: Text(smsCode[position], style: TextStyle(color: Colors.black),)),
      );
    } catch (e) {
      return Container(
        height: 40,
