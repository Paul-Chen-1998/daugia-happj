...
class _UpdateState extends State<Update> {
  ...
  Future<dynamic> getDetail() {
    ...
    return itemRef
        ...
        .equalTo(widget.keyy)
        .once()
        .then((DataSnapshot snashot) {
      Map data = snashot.value;
      data.forEach((index, data) {
        key = index;
        productTitle = new TextEditingController(text: data['nameProduct']);
        productPrice =
            new TextEditingController(text: data['startPriceProduct']);
        productDesc = new TextEditingController(text: data['description']);
        productStatus = new TextEditingController(text: data['status']);
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    return !loadding
        ? new Scaffold(
            ...
            appBar: new AppBar(
              flexibleSpace:
                  GradientAppbar(Colors.green[700], Colors.grey[400]),
              ...
              child: new Column(
                ...
                children: <Widget>[
                  ...
                  productTextField(
                      ...
                      textHint:
                          "Vd (hàng đã qua sử dụng, hàng còn bảo hành, ...)",
                  ...
                  productTextField(
                      ...
                      textHint:
                          "Vd (Máy còn chạy tốt, chưa qua sửa chữa lần nào, trong máy có sẵn AI, ...)",
...
//  ];
  ...
  addNewProducts() {
    ...
    String timeStampAfter =
        (int.parse(convertExtraTime(selectedExtraTime)) + timeStampNow)
            .toString();
...
//        "product time : $selectedExtraTime\nmiliseconds : $timeStampAfter\nid type : $idType");
    ...
    if (productTitle.text.length > 100) {
      showSnackBar(
          "Product name cannot be greater than 100 characters", scaffoldKey);
      return;
    }
